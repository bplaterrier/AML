function [test_eval,train_eval] = ml_kcv(x, t, K, f, ml_type)
...
for k=1:K
    ...
    if strcmp(ml_type,'classification')
        ...
        [train_eval,test_eval] = ml_kcv_clustering_eval(x,t,g,train,test,k,train_eval,test_eval);
        
    elseif strcmp(ml_type,'regression')
        
        [train_eval,test_eval] = ml_kcv_regression_eval(x,t,g,train,test,k,train_eval,test_eval);
